...
//        let au = FlagCode.A.rawValue + FlagCode.U.rawValue
//        println(au)
//        label.text = "\u{1F1E9}\u{1F1EA}"
//        
...
//            let name: String = country.0
//            let n1 = Array(name)[0]
//            println("\(FlagCode(char: Array(name)[0]).rawValue)\(FlagCode(char: Array(name)[1]).rawValue)")}
